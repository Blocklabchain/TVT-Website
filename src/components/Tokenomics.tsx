...
export default function Tokenomics(props: any) {
    ...
    return (
        <div className="w-full flex flex-col items-center mt-[150px]">
            ...
            <div className="w-full md:w-[1024px] flex flex-row items-center justify-between">
                <div className="w-[308px] flex flex-col items-start">
                    <p className="text-[30px] bg-gradient-to-b text-start from-white  to-[#B3ACBE]   text-transparent bg-clip-text">
                        TVT
                    </p>
                    <p className="text-[17px] bg-gradient-to-b text-start from-white  to-[#B3ACBE]   text-transparent bg-clip-text">
                        TVT is our SPL Token on Solana with 0% Fees. There will be a percentage of the company's profits buyback each month on it
                    </p>
                    <div className="p-[12px_16px] w-[510px] h-[308px] mt-[37px] rounded-[12px] border-[1px] border-white border-opacity-10">
                        ...
                        <div className="flex flex-row items-center justify-between mt-[34px]">
                            ...
                            <p className="text-[#3275F8] font-[400] text-[12px]">
                        ...
                        <div className="flex flex-row items-center justify-center gap-[30px] mt-[28px]">
                            <HoverBorderGradient
                                ...
                                as="button"
                                className="w-[180px] flex flex-col items-center rounded-[12px]  justify-center dark:bg-black bg-white text-black dark:text-white  space-x-2  gap-4"
                            >
                                Whitepaper
                            </HoverBorderGradient>
                            <HoverBorderGradient
                                containerClassName="rounded-[12px]"
                                as="button"
                                className=" w-[180px] flex flex-col items-center justify-center rounded-[12px] dark:bg-black bg-white text-black dark:text-white  space-x-2 gap-4"
                            >
                                Audit
                            </HoverBorderGradient>
                        </div>
